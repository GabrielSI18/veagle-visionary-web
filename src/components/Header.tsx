    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center">
          <div className="text-2xl font-bold text-veagle-purple transition-all duration-300 flex items-center">
            <span className="mr-2">Veagle</span>
            <div className={cn(
              "h-8 w-8 bg-veagle-purple rounded-full flex items-center justify-center text-white",
